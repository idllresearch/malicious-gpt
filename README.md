...
- Major Claim 3: [Evaluation on "ignore the above instructions" prompt leaking attack](./jailbreak_prompt_uncovering)
  ...
  - Result
- Other Claims
  - [malPrompt](https://github.com/idllresearch/malicious-gpt/tree/main/mal_prompts): 45 malicious prompts collected from the listings of malicious LLM applications (Malla)
  - [MallaResponse](https://github.com/idllresearch/malicious-gpt/tree/main/malicious_LLM_responses): Responses of 207 malicious LLM applications to the 45 malicious prompts
  - [MallaJailbreak](https://github.com/idllresearch/malicious-gpt/tree/main/jailbreak): 182 jailbreak prompts gathered from 200 malicious LLM applications
  - [ULLM-QA](https://github.com/idllresearch/malicious-gpt/tree/main/LLM_responses): A large dataset containing the 33,996 prompt-response pairs generated by GPT-3.5, Davinci-002, Davinci-003, GPT-J, Luna AI Llama2 Uncensored, and Pygmalion-13B
