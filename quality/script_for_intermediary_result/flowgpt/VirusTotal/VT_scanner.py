...
def main(msgfile, dirname):
    outfile = os.path.join(dirname, os.path.basename(file).replace("QA-FlowGPT", "VT_refined-flowgpt-malla"))
    ...
    for i, line in enumerate(contents):
        ...
        if queryID in mal_IDs:
            ...
            result_line = {"bot_name": bot_name, "queryID": queryID, "count": line["count"],
            ...
            result_line = {"bot_name": bot_name, "queryID": queryID, "count": line["count"], "query": query,
                           "type": "web", "msg_report_v3": web_msg_report_v3}
        else:
            continue
        print(i)
