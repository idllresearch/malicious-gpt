...
# Function to prepare a dictionary with initial values for files in the given directory
...
# Function to extract the code format and compilability results
...
# Function to summarize the code (malicious code + web code) format and compilability results
...
# Function to extract the code evasion results based on VirusTotal analysis
...
# Function to summarize code (malicious code + web code) evasion results and update the final dictionary
...
# Function to extract email format and fluency (using the Gunning Fog Index) results
...
# Function to extract email evasion results based on spam detection
...
# Function to summarize email results and update the final dictionary
...
# Function to summarize the final results
...
def main():
    FVdirname = "./codeSyn"
    VTdirname = "./codeDetection"
    fog_dirname = "./mailFluency"
    oop_dirname = "./mailDetection"
